...
const portableComponents = {
  types: {
    image: (value: any) => {
      const built = buildSanityImage(value.value, { width: 1200, height: 700 });
      if (!built) return null;
      return (
        <div className="relative mb-6 h-80 w-full overflow-hidden rounded-xl border border-gray-200 shadow-sm dark:border-gray-700">
          <Image
            src={built.url}
            ...
            <div className="space-y-2">
              {project.links?.live && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-2 rounded-full border border-gray-300 bg-white px-3 py-1.5 font-semibold text-gray-800 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100"
                >
